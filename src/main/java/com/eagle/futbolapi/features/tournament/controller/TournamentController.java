...
public class TournamentController
  ...
  public Page<TournamentDTO> getTournamentsByOrganizationAndActive(Long organizationId, Boolean active,
    ...
    return tournaments.map(mapper::toTournamentDTO);
  }

  @GetMapping("/byTypeAndActive")
  public Page<TournamentDTO> getTournamentsByTypeAndActive(TournamentType type, Boolean active, Pageable pageable) {
