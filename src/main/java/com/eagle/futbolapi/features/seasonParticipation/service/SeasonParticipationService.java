...
@Transactional
@Validated
public class SeasonParticipationService extends BaseCrudService<SeasonParticipation, Long, SeasonParticipationDto> {

  private final SeasonService seasonService;
  private final TeamService teamService;

  protected SeasonParticipationService(SeasonParticipationRepository repository, SeasonParticipationMapper mapper,
  ...
  @Override
  protected boolean isDuplicate(@NotNull SeasonParticipation seasonTeam) {
    Objects.requireNonNull(seasonTeam, "SeasonTeam cannot be null");
    return isDuplicate(seasonTeam, UniquenessStrategy.ALL);
  }

  @Override
  protected boolean isDuplicate(@NotNull Long id, @NotNull SeasonParticipation seasonTeam) {
  ...
  @Override
  protected void resolveRelationships(SeasonParticipationDto dto, SeasonParticipation seasonTeam) {
