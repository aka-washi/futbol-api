...
@Validated
public class OrganizationController extends BaseCrudController<Organization, OrganizationDTO, OrganizationService, OrganizationMapper> {
    ...
    public ResponseEntity<ApiResponse<Page<OrganizationDTO>>> getOrganizationsByCountryId(
        ...
        Pageable pageable = ResponseUtil.buildPageable(page, size, sortBy, sortDir);
        Page<Organization> organizationPage = service.getOrganizationsByCountryId(countryId, pageable);
        Page<OrganizationDTO> organizationDTO = organizationPage.map(mapper::toOrganizationDTO);
    ...
    public ResponseEntity<ApiResponse<Page<OrganizationDTO>>> getOrganizationsByParentOrganizationId(
        ...
        Pageable pageable = ResponseUtil.buildPageable(page, size, sortBy, sortDir);
        Page<Organization> organizationPage = service.getOrganizationsByParentOrganizationId(parentId, pageable);
        Page<OrganizationDTO> organizationDTO = organizationPage.map(mapper::toOrganizationDTO);
    ...
    public ResponseEntity<ApiResponse<Page<OrganizationDTO>>> searchOrganizationsByName(
        ...
        Pageable pageable = ResponseUtil.buildPageable(page, size, sortBy, sortDir);
        Page<Organization> organizationPage = service.searchOrganizationsByName(searchTerm, pageable);
        Page<OrganizationDTO> organizationDTO = organizationPage.map(mapper::toOrganizationDTO);
    ...
    protected Organization getEntityById(Long id) {
        return service.getById(id)
                .orElseThrow(() -> new ResourceNotFoundException(RESOURCE_NAME + NOT_FOUND_SUFFIX, "id", id));
    }
    ...
    protected Organization toEntity(OrganizationDTO dto) {
        return mapper.toOrganizationEntity(dto);
    }
