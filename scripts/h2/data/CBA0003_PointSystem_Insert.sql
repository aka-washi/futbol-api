...
MERGE INTO PointSystem (pts_id, pts_name, pts_display_name, pts_description, pts_points_for_win, pts_points_for_draw, pts_points_for_loss, pts_points_for_win_on_penalties, pts_points_for_loss_on_penalties, pts_points_for_forfeit_win, pts_points_for_forfeit_loss, pts_created_at, pts_created_by)
KEY (pts_name)
VALUES 
