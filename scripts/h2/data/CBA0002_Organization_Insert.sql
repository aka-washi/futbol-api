...
MERGE INTO Organization (org_id, org_name, org_display_name, org_type, org_abbreviation, country_id, org_founded, parent_organization_id, org_logo, org_website, org_headquarters, org_description, org_created_at, org_created_by)
KEY (org_abbreviation)
VALUES 
